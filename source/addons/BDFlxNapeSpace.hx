 ...
 */
class BDFlxNapeSpace extends FlxBasic {
	...
	public static function init():Void {
		...
		#else
		FlxG.plugins.addPlugin(new BDFlxNapeSpace());
		#end
	...
	static function set_drawDebug(drawDebug:Bool):Bool {
		...
		return BDFlxNapeSpace.drawDebug = drawDebug;
	}
	...
	override public function update(elapsed:Float):Void {
		if (space != null && elapsed > 0)
			space.step(elapsed * timeScale, velocityIterations, positionIterations);
	}
