...
/**
 * BDFlxNapeSprite consists of a FlxSprite with a physics body.
 ...
 */
class BDFlxNapeSprite extends FlxSprite {
	/**
	...
	/**
	 * Creates a BDFlxNapeSprite with an optional physics body.
	...
	override public function revive():Void {
		...
		if (body != null) {
			body.space = BDFlxNapeSpace.space;
		}
	}
	...
	public function destroyPhysObjects():Void {
		if (body != null) {
			if (BDFlxNapeSpace.space != null)
				BDFlxNapeSpace.space.bodies.remove(body);
			body = null;
		}
	}
